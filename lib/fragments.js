...
function Oe({ data: e, path: o, rootLabel: t, onPathChange: r, onCopyPath: n, pathCopied: c }) {
  ...
  return /* @__PURE__ */ a("div", { className: "px-3 py-2 flex-shrink-0 flex items-center gap-2 overflow-hidden", children: /* @__PURE__ */ a(Me, { className: "whitespace-nowrap overflow-hidden text-ellipsis", children: /* @__PURE__ */ l(ze, { className: "flex-nowrap", children: [
    /* @__PURE__ */ a(J, { children: o.length === 0 ? /* @__PURE__ */ l(E, { className: "font-mono font-medium text-secondary-foreground bg-secondary px-1.5 py-0.5 rounded-sm flex items-center gap-1.5", children: [
      t && /* @__PURE__ */ a(
        "button",
        {
          onClick: n,
    ...
    o.map((h, w) => {
      ...
      return /* @__PURE__ */ l("span", { className: "contents", children: [
        /* @__PURE__ */ a(q, {}),
        /* @__PURE__ */ a(J, { children: f ? /* @__PURE__ */ l(E, { className: "font-mono font-medium text-secondary-foreground bg-secondary px-1.5 py-0.5 rounded-sm flex items-center gap-1.5", children: [
          /* @__PURE__ */ a(
            "button",
            {
              onClick: n,
    ...
    u && /* @__PURE__ */ l(L, { children: [
      /* @__PURE__ */ a(q, {}),
      /* @__PURE__ */ a(J, { children: /* @__PURE__ */ l(he, { open: s, onOpenChange: i, children: [
        ...
        /* @__PURE__ */ a(fe, { align: "start", className: "w-56 p-1", children: /* @__PURE__ */ a(Le, { children: /* @__PURE__ */ l(Pe, { className: "max-h-[240px] overflow-y-auto", children: [
          ...
          /* @__PURE__ */ a(Je, { children: k.map(({ key: h, type: w, color: f }) => /* @__PURE__ */ l(
            Ie,
            {
              ...
              children: [
                /* @__PURE__ */ a("span", { className: "font-mono truncate", children: I(h) }),
...
function ho({
  ...
  return /* @__PURE__ */ l("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ l("div", { className: "flex items-center gap-2 min-w-0 bg-muted/40 p-2 rounded-md border border-border/50", children: [
      ...
      /* @__PURE__ */ a("p", { className: "font-mono text-xs text-foreground/80 truncate flex-1 leading-none", title: o, children: x.isDataUrl ? /* @__PURE__ */ l(L, { children: [
...
function fo({
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(o, { className: g("h-4 w-4 shrink-0 mt-0.5", i[e]) }),
        /* @__PURE__ */ l("div", { className: "space-y-1 min-w-0 flex-1", children: [
          ...
          (r || n && c) && /* @__PURE__ */ l("p", { className: "text-sm text-muted-foreground", children: [
            r,
            n && c && /* @__PURE__ */ l(L, { children: [
              r && " ",
              /* @__PURE__ */ a(
                P,
                {
