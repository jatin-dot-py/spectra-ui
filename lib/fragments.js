...
function ke(e) {
  ...
  for (const t of e) {
    ...
    for (let u = 0; u < r.length; u++) {
      const i = r[u];
      c = c ? `${c}/${i}` : i;
      const s = u === r.length - 1;
      let g = n.find((d) => d.name === i);
      g || (g = {
        name: i,
        path: c,
        isFolder: !s,
        children: []
      }, n.push(g)), s || (n = g.children);
    }
  }
  return U(o);
}
...
function Q({
  ...
  const s = n.has(e.path), g = t === e.path, d = o * 14;
  if (e.isFolder) {
    const p = Se(e.name, s);
    return /* @__PURE__ */ l("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ l(
        "button",
        {
          ...
          style: { paddingLeft: `${d + 6}px` },
          children: [
            s ? /* @__PURE__ */ a(te, { className: "h-3.5 w-3.5 text-muted-foreground flex-shrink-0" }) : /* @__PURE__ */ a(re, { className: "h-3.5 w-3.5 text-muted-foreground flex-shrink-0" }),
            /* @__PURE__ */ a(
              D,
              {
                name: p,
      ...
      s && /* @__PURE__ */ l("div", { className: "relative", children: [
        i && /* @__PURE__ */ a(
          "div",
          {
            className: "absolute top-0 bottom-0 border-l border-border",
...
function uo({
  ...
  const u = C(() => ke(e), [e]), [i, s] = N(() => {
    const d = /* @__PURE__ */ new Set();
    if (t) {
      const b = t.split("/");
      let p = "";
      for (let k = 0; k < b.length - 1; k++)
        p = p ? `${p}/${b[k]}` : b[k], d.add(p);
    }
    return d;
  }), g = (d) => {
    s((b) => {
  ...
  return /* @__PURE__ */ l("div", { className: "flex flex-col h-full border border-border rounded-lg overflow-hidden bg-background", children: [
    ...
    /* @__PURE__ */ a("div", { className: "flex-1 min-h-0 overflow-hidden", children: /* @__PURE__ */ a("div", { className: "h-full w-full overflow-auto", children: /* @__PURE__ */ a("div", { className: "py-1 min-w-max", children: u.map((d) => /* @__PURE__ */ a(
      Q,
      {
        node: d,
        depth: 0,
...
function ee({
  ...
  const [d, b] = N(!1), p = Y(e), k = t ? je(t) : null, v = k?.language ?? p.language, h = k?.label ?? p.label, { content: w, isJson: f } = C(() => Fe(o), [o]), x = f ? "json" : v, y = () => {
      ...
      children: [
        /* @__PURE__ */ a(
          "button",
          {
            ...
            children: d ? /* @__PURE__ */ a(T, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ a(M, { className: "h-3.5 w-3.5" })
          }
        ),
...
function L({ className: e, ...o }) {
  return /* @__PURE__ */ a(
    "li",
    {
      ...
      className: m("gap-1 inline-flex items-center", e),
      ...o
    }
  );
}
function $({
  ...
  return /* @__PURE__ */ a(
    r,
    {
      ...
      className: m("hover:text-foreground transition-colors", o),
      ...t
    }
  );
}
...
function Re({
  ...
  return /* @__PURE__ */ a(
    P.Empty,
    {
      ...
      className: m("py-6 text-center text-xs", e),
      ...o
    }
  );
}
function Je({
  ...
  return /* @__PURE__ */ a(
    P.Group,
    {
      ...
      className: m("text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs", e),
      ...o
    }
  );
}
...
function Oe({ data: e, path: o, rootLabel: t, onPathChange: r, onCopyPath: n, pathCopied: c }) {
  const [u, i] = N(!1), s = C(() => De(e, o), [e, o]), g = C(() => Be(s), [s]), d = s !== null && typeof s == "object" && g.length > 0, b = (h) => {
    r(o.slice(0, h));
  }, p = (h) => {
    r([...o, h]), i(!1);
  }, k = C(() => g.map((h) => {
...
function mo({
  ...
  const [i, s] = N([]), [g, d] = N(!1), b = C(() => Ve(o, i), [o, i]), p = C(() => {
    try {
    ...
    navigator.clipboard.writeText(Ae(i, t)), d(!0), setTimeout(() => d(!1), 2e3);
  }, [i, t]);
  return /* @__PURE__ */ l(
    "div",
    {
      className: "flex flex-col bg-background overflow-hidden",
      style: { maxHeight: c, maxWidth: u, height: "100%" },
      children: [
...
function Ge({ className: e, ...o }) {
  return /* @__PURE__ */ a("div", { "data-slot": "table-container", className: "relative w-full overflow-x-auto", children: /* @__PURE__ */ a(
    ...
    {
      "data-slot": "table",
      className: m("w-full caption-bottom text-xs", e),
      ...o
    }
  ) });
}
...
function W({ className: e, ...o }) {
  return /* @__PURE__ */ a(
    ...
    {
      "data-slot": "table-row",
      className: m("hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors", e),
      ...o
    }
  );
}
function _({ className: e, ...o }) {
  return /* @__PURE__ */ a(
    "th",
    {
      ...
      className: m("text-foreground h-10 px-2 text-left align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0", e),
      ...o
    }
  );
}
function K({ className: e, ...o }) {
  return /* @__PURE__ */ a(
    "td",
    {
      ...
      className: m("p-2 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0", e),
      ...o
    }
  );
}
function po({
  ...
  const u = Object.entries(e ?? {}), [i, s] = N(null), [g, d] = N(null), b = (f) => {
    s(i === f ? null : f);
  }, p = (f) => {
    f.stopPropagation();
    const x = u.map(([y, j]) => `${y}: ${j}`).join(`
`);
    navigator.clipboard.writeText(x), d("text"), setTimeout(() => d(null), 2e3);
  }, k = (f) => {
    f.stopPropagation(), navigator.clipboard.writeText(JSON.stringify(e, null, 2)), d("json"), setTimeout(() => d(null), 2e3);
  }, v = r || n;
...
function ho({
  ...
  return /* @__PURE__ */ l("div", { className: "space-y-2", children: [
    s && g && /* @__PURE__ */ l("div", { className: "flex items-center gap-2 p-2.5 rounded-md bg-destructive/10 border border-destructive/20 text-destructive", children: [
...
function fo({
  ...
  return /* @__PURE__ */ l(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ a(o, { className: m("h-5 w-5 shrink-0 mt-0.5", c[e]) }),
        /* @__PURE__ */ l("div", { className: "space-y-1 min-w-0 flex-1", children: [
          /* @__PURE__ */ a("h4", { className: "font-medium text-sm leading-6 text-foreground", children: t }),
