...
import { useMemo as S, useState as N } from "react";
import { ChevronDown as L, ChevronRight as R, X as J, Check as P, Copy as I } from "lucide-react";
import { c as k } from "./utils-B6yFEsav.js";
import { A as f } from "./LazyIcon-C_lOuP2P.js";
import { Prism as H } from "react-syntax-highlighter";
function O(o) {
  const e = [];
...
function y(o) {
  return o.map((e) => ({ ...e, children: y(e.children) })).sort((e, l) => e.isFolder && !l.isFolder ? -1 : !e.isFolder && l.isFolder ? 1 : e.name.localeCompare(l.name));
}
const b = {
...
}, B = "lucide-react:Folder", V = "lucide-react:FolderOpen";
function q(o, e = !1) {
  const l = o.toLowerCase(), t = A[l];
  return t || (e ? V : B);
}
const w = {
  // Text
...
}, E = { language: "text", label: "Plain Text" };
function W(o) {
  const e = o.split(";")[0].trim().toLowerCase();
  return w[e] ? w[e] : e.startsWith("text/") ? { language: "text", label: "Text" } : e.includes("json") ? { language: "json", label: "JSON" } : e.includes("xml") ? { language: "xml", label: "XML" } : e.includes("javascript") ? { language: "javascript", label: "JavaScript" } : E;
}
function j({
  node: o,
  depth: e,
    ...
    return /* @__PURE__ */ g("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ g(
        "button",
        {
          ...
          children: [
            d ? /* @__PURE__ */ a(L, { className: "h-3.5 w-3.5 text-muted-foreground flex-shrink-0" }) : /* @__PURE__ */ a(R, { className: "h-3.5 w-3.5 text-muted-foreground flex-shrink-0" }),
            /* @__PURE__ */ a(
              f,
              {
                name: s,
      ...
      children: [
        ...
        r && /* @__PURE__ */ a(
          "button",
          {
            ...
            children: /* @__PURE__ */ a(J, { className: "h-3 w-3" })
          }
        )
      ]
    }
...
function Y({ content: o, language: e, showLineNumbers: l }) {
  const t = typeof document < "u" && document.documentElement.classList.contains("dark");
  return o.length > T ? /* @__PURE__ */ g(
    "div",
    {
...
function te({
  ...
  const [u, c] = N(!1), d = C(o), p = l ? W(l) : null, n = p?.language ?? d.language, m = p?.label ?? d.label, { content: s, isJson: h } = S(
    () => _(e),
    [e]
  ), F = h ? "json" : n, M = () => {
    navigator.clipboard.writeText(e), c(!0), setTimeout(() => c(!1), 2e3);
  }, x = i?.left ?? o, z = i?.right ?? (h ? "JSON" : m);
  return /* @__PURE__ */ g("div", { className: "flex flex-col overflow-hidden bg-background", children: [
    /* @__PURE__ */ g("div", { className: "flex-1 overflow-auto relative group", children: [
      /* @__PURE__ */ a(
        "button",
        {
          onClick: M,
          ...
          children: u ? /* @__PURE__ */ a(P, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ a(I, { className: "h-3.5 w-3.5" })
        }
      ),
    ...
    r && /* @__PURE__ */ g("div", { className: "flex items-center justify-between gap-4 px-3 py-1 border-t border-border bg-muted/20 text-xs text-muted-foreground flex-shrink-0", children: [
      ...
      /* @__PURE__ */ a("span", { className: "uppercase flex-shrink-0", children: z })
    ] })
  ] });
}
export {
