...
import { useMemo as N, useState as y } from "react";
import { A as f, S as C, b } from "./LazyIcon-BSxE98wv.js";
import { ChevronDown as J, ChevronRight as P, X as I, Check as H, Copy as O } from "lucide-react";
...
function G(o) {
  ...
  for (const l of o) {
    ...
    for (let u = 0; u < t.length; u++) {
      const c = t[u];
      i = i ? `${i}/${c}` : c;
      const d = u === t.length - 1;
      let p = r.find((n) => n.name === c);
      p || (p = {
        name: c,
        path: i,
        isFolder: !d,
...
function j(o) {
  return o.map((e) => ({ ...e, children: j(e.children) })).sort((e, l) => e.isFolder && !l.isFolder ? -1 : !e.isFolder && l.isFolder ? 1 : e.name.localeCompare(l.name));
}
const k = {
...
}, q = "lucide-react:Folder", E = "lucide-react:FolderOpen";
function W(o, e = !1) {
  const l = o.toLowerCase(), t = V[l];
  return t || (e ? E : q);
}
const S = {
  // Text
...
}, X = { language: "text", label: "Plain Text" };
function $(o) {
  const e = o.split(";")[0].trim().toLowerCase();
  return S[e] ? S[e] : e.startsWith("text/") ? { language: "text", label: "Text" } : e.includes("json") ? { language: "json", label: "JSON" } : e.includes("xml") ? { language: "xml", label: "XML" } : e.includes("javascript") ? { language: "javascript", label: "JavaScript" } : X;
}
function F({
  node: o,
  depth: e,
  ...
  const d = r.has(o.path), p = l === o.path, n = e * 14;
  if (o.isFolder) {
    const s = W(o.name, d);
    return /* @__PURE__ */ g("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ g(
        "button",
        {
          ...
          children: [
            d ? /* @__PURE__ */ a(J, { className: "h-3.5 w-3.5 text-muted-foreground flex-shrink-0" }) : /* @__PURE__ */ a(P, { className: "h-3.5 w-3.5 text-muted-foreground flex-shrink-0" }),
            /* @__PURE__ */ a(
              f,
              {
                name: s,
      ...
      d && /* @__PURE__ */ g("div", { className: "relative", children: [
        c && /* @__PURE__ */ a(
          "div",
          {
            className: "absolute top-0 bottom-0 border-l border-border",
...
function te({
  ...
  const u = N(() => G(o), [o]), [c, d] = y(() => {
    const n = /* @__PURE__ */ new Set();
    if (l) {
      const m = l.split("/");
      let s = "";
      for (let h = 0; h < m.length - 1; h++)
        s = s ? `${s}/${m[h]}` : m[h], n.add(s);
    }
    return n;
  }), p = (n) => {
    d((m) => {
  ...
  return /* @__PURE__ */ g("div", { className: "flex flex-col h-full border border-border rounded-lg overflow-hidden bg-background", children: [
    ...
    /* @__PURE__ */ a("div", { className: "flex-1 min-h-0 overflow-hidden", children: /* @__PURE__ */ g(C, { className: "h-full w-full", children: [
      /* @__PURE__ */ a("div", { className: "py-1 min-w-max", children: u.map((n) => /* @__PURE__ */ a(
        F,
        {
          node: n,
          depth: 0,
      ...
      /* @__PURE__ */ a(b, { orientation: "vertical" }),
      /* @__PURE__ */ a(b, { orientation: "horizontal" })
    ] }) })
  ] });
}
function re({
...
function Q({ content: o, language: e, showLineNumbers: l }) {
  const t = typeof document < "u" && document.documentElement.classList.contains("dark");
  return o.length > M ? /* @__PURE__ */ g(
    "div",
    {
      className: "text-xs font-mono p-3",
      style: { background: "hsl(var(--muted))" },
      children: [
        /* @__PURE__ */ g("div", { className: "text-muted-foreground text-[10px] uppercase mb-2 pb-2 border-b border-border", children: [
          "Syntax highlighting disabled (",
          Math.round(o.length / 1e3),
          "KB)"
        ] }),
        /* @__PURE__ */ a("pre", { className: "whitespace-pre-wrap break-words text-foreground", children: o })
      ]
    }
  ) : /* @__PURE__ */ a(
    D,
...
function K(o) {
  ...
  try {
    ...
    return { content: JSON.stringify(e, null, 2), isJson: !0 };
  } catch {
    return { content: o, isJson: !1 };
  }
}
function ne({
  ...
  const [u, c] = y(!1), d = T(o), p = l ? $(l) : null, n = p?.language ?? d.language, m = p?.label ?? d.label, { content: s, isJson: h } = N(
    () => K(e),
    [e]
  ), z = h ? "json" : n, L = () => {
    navigator.clipboard.writeText(e), c(!0), setTimeout(() => c(!1), 2e3);
  }, v = i?.left ?? o, R = i?.right ?? (h ? "JSON" : m);
  return /* @__PURE__ */ g("div", { className: "flex flex-col overflow-hidden bg-background", children: [
    /* @__PURE__ */ g(C, { className: "flex-1 relative group", children: [
      /* @__PURE__ */ a(
        "button",
        {
          onClick: L,
          ...
          children: u ? /* @__PURE__ */ a(H, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ a(O, { className: "h-3.5 w-3.5" })
        }
      ),
      /* @__PURE__ */ a("div", { className: "min-w-max", children: /* @__PURE__ */ a(
        Q,
        {
          content: s,
          language: z,
    ...
    r && /* @__PURE__ */ g("div", { className: "flex items-center justify-between gap-4 px-3 py-1 border-t border-border bg-muted/20 text-xs text-muted-foreground flex-shrink-0", children: [
      /* @__PURE__ */ a("span", { className: "truncate", title: v, children: v }),
      /* @__PURE__ */ a("span", { className: "uppercase flex-shrink-0", children: R })
    ] })
  ] });
}
export {
