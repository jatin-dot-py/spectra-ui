import { jsxs as i, jsx as t, Fragment as J } from "react/jsx-runtime";
import { useMemo as S, useState as w, useEffect as te, useCallback as B } from "react";
import { ChevronDown as ne, ChevronRight as re, X as le, Check as L, Copy as P, ChevronRightIcon as ie, CheckIcon as oe, FileJson as ce, AlertCircle as se, Clock as de, Package as ue, ArrowRightLeft as me, Globe as ge } from "lucide-react";
import { c as p } from "./utils-B6yFEsav.js";
import { A as G, B as T } from "./badge-B1vpNSNG.js";
...
import { A as Ne, a as V } from "./ActionButtonGroup-D1TNSW-7.js";
function ye(e) {
  const a = [];
...
function Y(e) {
  return e.map((a) => ({ ...a, children: Y(a.children) })).sort((a, n) => a.isFolder && !n.isFolder ? -1 : !a.isFolder && n.isFolder ? 1 : a.name.localeCompare(n.name));
}
const A = {
...
function Fe(e) {
  ...
  return z[a] ? z[a] : a.startsWith("text/") ? { language: "text", label: "Text" } : a.includes("json") ? { language: "json", label: "JSON" } : a.includes("xml") ? { language: "xml", label: "XML" } : a.includes("javascript") ? { language: "javascript", label: "JavaScript" } : Te;
}
function Z({
  node: e,
  depth: a,
...
function ee({
  ...
  const [g, N] = w(!1), v = Q(e), d = n ? Fe(n) : null, b = d?.language ?? v.language, y = d?.label ?? v.label, { content: x, isJson: C } = S(() => Ie(a), [a]), k = C ? "json" : b, j = S(
    () => Je(x, l),
    [x, l]
  ), M = () => {
    navigator.clipboard.writeText(a), N(!0), setTimeout(() => N(!1), 2e3);
  }, F = c?.left ?? e, D = c?.right ?? (C ? "JSON" : y), ae = o || `${j}px`;
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(
          "button",
          {
            ...
            children: g ? /* @__PURE__ */ t(L, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ t(P, { className: "h-3.5 w-3.5" })
          }
        ),
        ...
        l && /* @__PURE__ */ i("div", { className: "flex items-center justify-between gap-4 px-3 py-1 border-t border-border bg-muted/20 text-xs text-muted-foreground", style: { flexShrink: 0 }, children: [
          /* @__PURE__ */ t("span", { className: "truncate", title: F, children: F }),
          /* @__PURE__ */ t("span", { className: "uppercase", style: { flexShrink: 0 }, children: D })
        ] })
      ]
    }
  );
...
function Ee({ data: e, path: a, rootLabel: n, onPathChange: r, onCopyPath: l, pathCopied: c }) {
  const [s, o] = w(!1), u = S(() => Ve(e, a), [e, a]), h = S(() => Re(u), [u]), m = u !== null && typeof u == "object" && h.length > 0, f = (d) => {
    r(a.slice(0, d));
  }, g = (d) => {
    r([...a, d]), o(!1);
  }, N = S(() => h.map((d) => {
  ...
  return /* @__PURE__ */ t("div", { className: "px-3 py-2 flex-shrink-0 flex items-center gap-2 overflow-hidden", children: /* @__PURE__ */ t(He, { className: "whitespace-nowrap overflow-hidden text-ellipsis", children: /* @__PURE__ */ i(De, { className: "flex-nowrap", children: [
    /* @__PURE__ */ t(O, { children: a.length === 0 ? /* @__PURE__ */ i(_, { className: "font-mono font-medium text-secondary-foreground bg-secondary px-1.5 py-0.5 rounded-sm flex items-center gap-1.5", children: [
      n && /* @__PURE__ */ t(
        "button",
        {
          onClick: l,
          ...
          title: "Copy path",
          children: c ? /* @__PURE__ */ t(L, { className: "h-3 w-3" }) : /* @__PURE__ */ t(P, { className: "h-3 w-3" })
        }
      ),
      v
    ] }) : /* @__PURE__ */ t(
    ...
    a.map((d, b) => {
      const y = b === a.length - 1;
      return /* @__PURE__ */ i("span", { className: "contents", children: [
        /* @__PURE__ */ t(q, {}),
        /* @__PURE__ */ t(O, { children: y ? /* @__PURE__ */ i(_, { className: "font-mono font-medium text-secondary-foreground bg-secondary px-1.5 py-0.5 rounded-sm flex items-center gap-1.5", children: [
          /* @__PURE__ */ t(
            "button",
            {
              onClick: l,
    ...
    m && /* @__PURE__ */ i(J, { children: [
      /* @__PURE__ */ t(q, {}),
      /* @__PURE__ */ t(O, { children: /* @__PURE__ */ i(fe, { open: s, onOpenChange: o, modal: !0, children: [
        ...
        /* @__PURE__ */ t(xe, { align: "start", className: "w-56 p-1", children: /* @__PURE__ */ t(Ae, { children: /* @__PURE__ */ i(Oe, { className: "max-h-[240px] overflow-y-auto", children: [
          ...
          /* @__PURE__ */ t(Be, { children: N.map(({ key: d, type: b, color: y }) => /* @__PURE__ */ i(
            Ge,
            {
              value: String(d),
              onSelect: () => g(d),
              ...
              children: [
                /* @__PURE__ */ t("span", { className: "font-mono truncate", children: $(d) }),
                /* @__PURE__ */ t("span", { className: `text-[10px] ${y} opacity-80 flex-shrink-0 ml-2`, children: b })
              ]
            },
            String(d)
          )) })
...
function Sa({
  ...
  const [g, N] = w(r ?? []), [v, d] = w(!1), b = S(() => _e(a, g), [a, g]), y = typeof b == "string", { displayContent: x, mimeType: C } = S(() => {
    if (y)
      return { displayContent: b, mimeType: "text/plain" };
    try {
      return { displayContent: JSON.stringify(b, null, 2), mimeType: "application/json" };
    } catch {
      return { displayContent: String(b ?? "undefined"), mimeType: "text/plain" };
    }
  }, [b, y]), k = S(() => Ke(x), [x]), j = o || `${k}px`, M = B((D) => {
    N(D);
  }, []), F = B(() => {
    navigator.clipboard.writeText(qe(g, n)), d(!0), setTimeout(() => d(!1), 2e3);
  }, [g, n]);
  return /* @__PURE__ */ i(
    "div",
    {
      className: `flex flex-col bg-background ${f || ""}`,
      style: { height: j, width: u, maxHeight: h, maxWidth: m },
      children: [
...
function wa({
  ...
  const s = Object.entries(e ?? {}), [o, u] = w(null), [h, m] = w(null), f = (d) => {
    u(o === d ? null : d);
  };
    ...
    (r || l) && /* @__PURE__ */ i(Ne, { align: "end", gap: "sm", children: [
      r && /* @__PURE__ */ t(
        V,
        {
          ...
          icon: h === "text" ? L : P,
          onClick: () => {
            const d = s.map(([b, y]) => `${b}: ${typeof y == "object" ? JSON.stringify(y) : y}`).join(`
`);
    ...
    /* @__PURE__ */ t("div", { className: "rounded border border-border overflow-hidden", children: /* @__PURE__ */ i(Xe, { className: "table-fixed w-full", children: [
      !c && /* @__PURE__ */ t(We, { children: /* @__PURE__ */ i(K, { className: "bg-muted/30", children: [
        /* @__PURE__ */ t(X, { className: "w-[180px] text-xs font-medium", children: a }),
        /* @__PURE__ */ t(X, { className: "text-xs font-medium", children: n })
      ] }) }),
      /* @__PURE__ */ t(Ue, { children: s.map(([d, b]) => {
        const y = o === d, { display: x, className: C, wrapInCode: k } = Ye(b);
        return /* @__PURE__ */ i(
          K,
          {
            onClick: () => f(d),
            ...
            children: [
              ...
              /* @__PURE__ */ t(
                W,
                {
                  ...
                  children: k ? /* @__PURE__ */ t("code", { className: "px-1.5 py-0.5 rounded bg-muted text-foreground border border-border", children: x }) : x
                }
              )
            ]
          },
...
function ra({
  ...
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ t(a, { className: p("h-4 w-4 shrink-0 mt-0.5", o[e]) }),
...
function Ca({
  ...
  actionButtonIcon: g,
  onActionButtonClick: N,
  actionButtonVariant: v = "outline",
  actionButtonTitle: d
}) {
  const [b, y] = w(!1), x = Qe(a), C = async () => {
    await navigator.clipboard.writeText(a), y(!0), setTimeout(() => y(!1), 2e3);
  }, k = (F) => {
    F.stopPropagation(), N?.();
  }, j = aa(n), M = j ? Ze(n) : "secondary";
  return /* @__PURE__ */ i("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ i("div", { className: "flex items-center gap-2 flex-wrap", children: [
      ...
      m && /* @__PURE__ */ i(
        H,
        {
          ...
          title: d,
          children: [
            g && /* @__PURE__ */ t(g, { className: "h-3.5 w-3.5" }),
    ...
    /* @__PURE__ */ i("div", { className: "flex items-center gap-2 min-w-0 bg-muted/40 p-2 rounded-md border border-border/50", children: [
      ...
      /* @__PURE__ */ t("p", { className: "font-mono text-xs text-foreground/80 truncate flex-1 leading-none", title: a, children: x.isDataUrl ? /* @__PURE__ */ i(J, { children: [
        /* @__PURE__ */ t("span", { className: "text-muted-foreground", children: x.protocol }),
        /* @__PURE__ */ t("span", { children: x.host }),
        /* @__PURE__ */ t("span", { className: "text-muted-foreground ml-1", children: x.path })
      ] }) : /* @__PURE__ */ i(J, { children: [
        /* @__PURE__ */ i("span", { className: "text-muted-foreground", children: [
          x.protocol,
          "//"
        ] }),
        /* @__PURE__ */ t("span", { className: "font-medium", children: x.host }),
        /* @__PURE__ */ t("span", { className: "text-foreground/60", children: x.path })
      ] }) }),
      /* @__PURE__ */ t(
        H,
        {
          ...
          title: "Copy URL",
          children: b ? /* @__PURE__ */ t(L, { className: "h-3.5 w-3.5 text-green-500" }) : /* @__PURE__ */ t(P, { className: "h-3.5 w-3.5 text-muted-foreground hover:text-foreground" })
        }
      )
    ] })
  ] });
...
function ka({
  ...
  const [f, g] = w(n), N = S(() => la(e), [e]), v = o || `${N}px`;
  return /* @__PURE__ */ i(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ t("div", { className: "flex-1 min-h-0", children: f === "code" ? /* @__PURE__ */ t(
          ee,
          {
            filename: a,
            content: e,
...
function ja({ items: e, className: a }) {
  ...
  return /* @__PURE__ */ t("div", { className: p("relative", a), children: e.map((r, l) => {
    ...
    return /* @__PURE__ */ i("div", { className: "relative flex gap-4", children: [
      ...
      /* @__PURE__ */ i("div", { className: p("flex-1 pb-8", o && "pb-0"), children: [
